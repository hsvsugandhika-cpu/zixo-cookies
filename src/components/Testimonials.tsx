        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="bg-dark-card rounded-2xl p-6 border border-dark-border shadow-sm hover:shadow-md transition-shadow"
            >
              <Quote className="w-8 h-8 text-gold/30 mb-4" />
              <p className="text-brown-300 text-sm leading-relaxed mb-6">&ldquo;{testimonial.text}&rdquo;</p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-dark-border flex items-center justify-center text-cream font-semibold text-sm">
                  {testimonial.avatar}
                </div>
                <div>
