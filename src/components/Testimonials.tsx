      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-3xl sm:text-4xl lg:text-5xl font-playfair font-bold text-brown-900 mt-3"
          >
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-brown-200 flex items-center justify-center text-brown-700 font-semibold text-sm">
                  {testimonial.avatar}
                </div>
                <div>
                  <p className="font-semibold text-brown-900 text-sm">{testimonial.name}</p>
